...
<font color="#777777"><strong>添加板块：</strong></font>
<form action="admin_subjectQuery.php" method="get" class="definewidth m20" enctype="multipart/form-data">
    <table style="margin-left:10px;margin-top:3px;">
        <tr>
            <td>板块名称：</td>
            <td><input type="text" name="name" style="width:400px;" placeholder='请输入板块名称'/></td>
        </tr>
        <tr>
            <td>顺序排列：</td>
        ...
        <tr>
            <td>版主：</td>
            <td><input type="text" name="banzhuid" style="width:400px;" placeholder='请输入排列顺序'/></td>
