...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        <td><a href="detail.php?id=<?php echo $value['id']; ?>" target="_blank"><?php echo $value['title']; ?></a></td>
        <td width="200">
            <pre><?php echo $value['content']; ?></pre>
        </td>
        <td><?php echo $value['uid']; ?></td>
        <td><?php if($value['del']){?> <a href="disposetz.php?rid=<?php echo $value['rid']; ?>&amp;del=0">恢复删除</a><?php } else { ?><a
                href="disposetz.php?rid=<?php echo $value['rid']; ?>&amp;del=1">删除</a><?php }?></td>
        <td><?php if($value['del']){?> <a href="disposetz.php?rid=<?php echo $value['rid']; ?>&amp;realdel=1">彻底删除</a><?php } else { ?><a
                href="disposetz.php?rid=<?php echo $value['rid']; ?>&amp;del=1">删除</a><?php }?></td>
    </tr>
