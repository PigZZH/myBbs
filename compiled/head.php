...
<body mycollectionplug="bind"
      style="background-size:100%;background:url(img/5-13050GS111.gif) ;/*background-repeat: repeat-y;*/ ">
<!--TOP start-->
<div id="toptb" class="cl">
    <div class="wp">
        <div class="z"><a href="#" class="hrefs"
                          onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.baidu.com');">设为首页</a><a
                href="javascript:;" onclick="window.external.AddFavorite(location.href,document.title);return false;">收藏本站</a>
        </div>
    </div>
</div>
<script>
...
<div id="hd">
    <div class="wp">
        <div class="hdc cl">
            <h2><a href="index.php" title="首页 - aa"><img src="./img/logo3.gif" height="80" border="0"></a></h2>
            <?php if (isset($_SESSION['username'])) { ?>
                ...
                <div id="um">
                    <div class="avt y"><a href="http://localhost/bbs/home_tx.php"><img
                    ...
                    <p>
                        ...
                        <span class="pipe">|</span>用户权限: <?php if (($_SESSION['type'])) { ?><a href="admin_login.php">管理员</a><?php } else { ?>普通用户<?php } ?>
                    </p>
                ...
                <?php if (is_array($bigtabledata)) {
                    foreach ($bigtabledata AS $key => $value) { ?>
                        <li id="mn_home"><a href="index.php?bigid=<?php echo $value['bid']; ?>" hidefocus="true"
                                            title="Space"><?php echo $value['name']; ?></a></li>
                    <?php }
                } ?>
