...
$limit = 10;
//查询所有主题帖的信息
$data = db_select($conn, 'bbs_details as d ,bbs_replay as r', 'r.id as rid,r.content,r.uid,r.tid,d.title,d.id,r.del', 'd.id=r.tid', null, setLimit($limit));
//查询所有主题帖的数量
$cdata = db_select($conn, 'bbs_replay', 'count(id) as c');
$count = $cdata[0]['c'];
